    ...
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-gray-800 to-gray-900 text-gray-200">
      <div className="w-full max-w-md p-8 space-y-6 bg-gray-800 bg-opacity-60 rounded-xl shadow-lg backdrop-blur-md">
        <div className="text-center">
          {/* Aqui iria el logo de Subastik, de momento esta este icono de prueba */}
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            <button
              type="submit"
              className="w-full px-6 py-3 mt-4 font-semibold text-white bg-red-600 rounded-lg hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-red-500 transition-all duration-200"
            >
              Registrarme
            </button>
          </div>
